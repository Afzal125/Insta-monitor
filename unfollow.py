...
if not path.exists('user_details.txt'): 
...
while True:
    ...
    try:
        ...
        print("\n",e)
    person = d[3]  # mention the username without '@'
    ...
    if not path.exists('followers_details.txt'):
        with open('followers_details.txt','w') as txtfile: # unfollowers.csv file saved on system
